...
def screenshot(first_name=None):
...
'''def weather():
    ...
    URL = "https://www.google.com/search?q=WEATHER&oq=WEATHER&aqs=chrome..69i57j5l2.1441j0j4&sourceid=chrome&ie=UTF-8"
    ...
    if temperature < '20°':
        ...
        speak("Sir, you do not need to wear woolen clothes to go outside.")
...
def message():
    ...
    userID = "atul2020cs176@abesit.edu.in"
    psd = 'abesit290'
    useragent = 'Atul sah'
...
def weather(audio_data):
    url = "https://www.google.com/search?q=WEATHER&oq=WEATHER&aqs=chrome..69i57j5l2.1441j0j4&sourceid=chrome&ie=UTF-8" + audio_data
    webbrowser.open(url)
    speak(f"Sir, the weather is {audio_data}  from weather.com")
